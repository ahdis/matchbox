...
public class MatchboxJpaPackageCache {
	...
	public void interceptEntityBeforeSaving(final NpmPackageVersionResourceEntity entity,
		...
		switch (res) {
			case org.hl7.fhir.r4.model.StructureDefinition ignored -> this.updateStructureDefinition(entity);
			case org.hl7.fhir.r4b.model.StructureDefinition ignored -> this.updateStructureDefinition(entity);
			case org.hl7.fhir.r5.model.StructureDefinition ignored -> this.updateStructureDefinition(entity);
	...
	/**
	 * This is Matchbox's hook to intercept the {@link NpmPackageVersionResourceEntity}s being generated when loading a
	 * package right after it got persisted in the database.
	 * <p>
	 * This will check the resource type and delegate to the appropriate method to customize the entity.
	 */
	...
	/**
	 * Update a StructureDefinition before it gets saved in the database.
	 */
	private void updateStructureDefinition(final NpmPackageVersionResourceEntity npmPackageVersionResourceEntity) {
		// Modify the original entity: we update the canonical version to the package version for StructureDefinitions
