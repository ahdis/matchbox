...
import ch.ahdis.matchbox.config.property.MatchboxFhirContextLlmProperties;
...
public class LlmConnector {
	...
	private void initializeChatModel() {
		this.chatMemory = MessageWindowChatMemory.builder()
			...
			.maxMessages(10)
			.build();
		this.chatMemory.add(SystemMessage.from(PROMPT));
		switch (this.provider) {
			...
			default:
				throw new IllegalArgumentException("Unsupported LLM provider: " + this.provider);
		}
	}
	...
	public String interpretWithMatchbox(String resource, String operationOutcome) {
		...
		try {
			...
			this.chatMemory.add(UserMessage.from(requestBody));
			final ChatRequest request = ChatRequest.builder()
				.messages(this.chatMemory.messages())
				.build();
			final ChatResponse response = this.model.chat(request);
